    ...
    <div className="bg-darkBlue w-full overflow-hidden min-h-screen">
      ...
      <div className="pt-20 px-4">
          ...
          <div className="sponsors-container">
            ...
            <div className='sponsor-logo-container-s bg-white'>
              <img src={pastSponsors} className="mx-auto mt-10 w-full bg-black max-w-[300px] md:max-w-[600px] lg:max-w-[700px] xl:max-w-[800px] h-auto" alt="Sponsor Logo" />
            </div>
          </div>
      </div>
