...
const PastEvents = () => {
  ...
  <section>
    <div className={`${styles.paddingX} flex-col relative`} id="about">
      <div className="grid place-items-center text-white xs:px-6 lg:px-40">
        <div className={`${styles.heading7} py-10`}>
          ABOUT US    
        </div>
          {/* <div className="pb-10"></div> */}
          {pastEventDescription.map((pastEvent) => (
            <div className="font-lighter font-inter lg:text-2xl md:text-2xl text-[1rem] pb-4 text-centre">
